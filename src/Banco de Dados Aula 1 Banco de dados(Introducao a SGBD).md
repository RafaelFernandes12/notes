# Banco de Dados Aula 1 Banco de dados(Introducao a SGBD)
...
**Assets:** https://drive.google.com/file/d/1Z2-uUj47KeYNhXxzIAzexuNoV7u3hwXc/view
**URL:**
...
1. e logicamente coerente (tem significado)
1. tem uma finalidade (e util para um grupo de usuarios)
...
1. projeto conceitual (ex.: diagrama ER)
1. projeto logico
1. projeto fisico
...
1. Questao 2 (evitar redundancia evita copias em lugares diferentes) → **Verdadeiro** (na pratica: a ideia e *controlar* redundancia)
1. Questao 3 (SGBD gerencia acesso, seguranca, integridade, desempenho, disponibilidade) → **Verdadeiro**
1. Questao 4 (alterar estruturas sem mudar programas) → **c) Independencia de dados**
